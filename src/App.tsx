...
function App() {
  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen bg-ccs-soft-blue dark:bg-ccs-dark transition-colors duration-200">
        {/* Sidebar */}
        <aside className="fixed left-0 top-0 h-screen w-64 bg-white dark:bg-ccs-dark border-r border-gray-200 dark:border-gray-700 z-30 transition-colors duration-200">
          <div className="p-6">
            <h1 className="text-xl font-bold text-ccs-dark dark:text-white">CCS CRM</h1>
          </div>
          <nav className="mt-2">
            <button 
              onClick={() => setCurrentView('dashboard')}
              className={`w-full flex items-center space-x-3 px-6 py-3 ${
                currentView === 'dashboard' ? 'bg-ccs-blue/10 text-ccs-blue border-r-4 border-ccs-blue' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'
              }`}
            >
              <Home size={20} />
              <span>Dashboard</span>
            ...
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-6 py-3 ${
                currentView === 'contacts' ? 'bg-ccs-blue/10 text-ccs-blue border-r-4 border-ccs-blue' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'
              }`}
            >
              <Users size={20} />
              <span>Contacts</span>
            ...
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-6 py-3 ${
                currentView === 'tickets' ? 'bg-ccs-blue/10 text-ccs-blue border-r-4 border-ccs-blue' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'
              }`}
            >
              <Ticket size={20} />
              <span>Tickets</span>
            ...
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-6 py-3 ${
                currentView === 'tasks' ? 'bg-ccs-blue/10 text-ccs-blue border-r-4 border-ccs-blue' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'
              }`}
            >
              <ListTodo size={20} />
              <span>Tasks</span>
            ...
            <button 
              ...
              className={`w-full flex items-center space-x-3 px-6 py-3 ${
                currentView === 'integrations' ? 'bg-ccs-blue/10 text-ccs-blue border-r-4 border-ccs-blue' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'
              }`}
            >
              <Cog size={20} />
        ...
        <div className="ml-64">
          {/* Header */}
          <header className="sticky top-0 bg-white dark:bg-ccs-dark border-b border-gray-200 dark:border-gray-700 z-20 transition-colors duration-200">
            <div className="px-8 py-4">
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-4">
                  <h2 className="text-2xl font-bold text-ccs-dark dark:text-white">
                ...
                <div className="flex items-center space-x-6">
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      placeholder="Search..."
                      className="pl-10 pr-4 py-2 w-64 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-ccs-blue bg-white dark:bg-gray-800 text-ccs-dark dark:text-white"
                      value={searchTerm}
                  ...
                  <div className="flex items-center space-x-3 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 px-3 py-2 rounded-lg">
                    <img
                    ...
                    <div className="text-sm">
                      <p className="font-medium text-ccs-dark dark:text-white">John Doe</p>
